        ...
        <div className="relative w-full max-w-md">
          ...
          <div className="mb-8 flex flex-col items-center text-center">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              Join{" "}
              <span className="font-semibold text-amber-800">Nepali Rudraksh</span>{" "}
          ...
          <div className="rounded-2xl border border-amber-900/10 bg-white/90 p-6 shadow-xl shadow-amber-950/5 backdrop-blur sm:p-8">
            <form className="space-y-4">
              ...
              <div className="space-y-2">
                <label htmlFor="fullname" className="text-sm font-medium text-[#422006]">
                  Full name
                </label>
              ...
              {/* Phone */}
              <div className="space-y-2">
                <label htmlFor="phone" className="text-sm font-medium text-[#422006]">
                  Phone number
                </label>
                <div className="relative">
              ...
              {/* Confirm Password */}
              <div className="space-y-2">
                <label htmlFor="confirm-password" className="text-sm font-medium text-[#422006]">
                  Confirm password
                </label>
                <div className="relative">
                  <Lock className="absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-muted-foreground" />
      ...
      <div className="relative hidden overflow-hidden lg:flex lg:w-1/2 lg:flex-col lg:justify-between bg-linear-to-br from-[#713f12] via-[#8B4A0F] to-[#422006]">
        ...
        <div className="relative px-12 pt-16">
          ...
          <p className="mt-4 text-base leading-relaxed text-amber-100/80">
            Create your account and unlock access to authentic Himalayan Rudraksha —
            sourced, verified, and delivered straight to your doorstep.
          </p>
        </div>
        ...
        <div className="relative px-12 pb-10">
          <div className="rounded-2xl border border-white/10 bg-white/5 p-5 backdrop-blur-sm">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-sm font-semibold text-white">10,000+ members</p>
                <div className="mt-0.5 flex items-center gap-1">
                  {[...Array(5)].map((_, i) => (
                    <Star key={i} className="h-3 w-3 fill-amber-400 text-amber-400" />
                  ))}
                  <span className="ml-1 text-xs text-amber-300/80">4.9 average rating</span>
                </div>
              </div>
            </div>
            <p className="mt-3 text-xs italic leading-relaxed text-amber-100/70">
              &ldquo;Joining was the best decision — the quality and authenticity is unmatched.&rdquo;
            </p>
          </div>
        </div>
      </div>
