...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-2xl border border-amber-900/10 bg-white text-card-foreground shadow-xs transition-all",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "text-base sm:text-lg font-bold leading-none tracking-tight text-[#422006]",
      className
    )}
    {...props}
  />
